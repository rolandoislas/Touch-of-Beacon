...
public class Potions {
	...
	public static void register() {
		...
		ForgeRegistries.POTIONS.register(QUENCH);
		...
		ForgeRegistries.POTION_TYPES.register(TYPE_QUENCH);
		ForgeRegistries.POTION_TYPES.register(TYPE_QUENCH_1);
		ForgeRegistries.POTION_TYPES.register(TYPE_QUENCH_2);
		ForgeRegistries.POTION_TYPES.register(TYPE_QUENCH_3);
